function [s,d,c]=p_dststb_l1(point)
%% check stability and return dominant frequency and distance using l1 instead of l0 (more accurate in some cases)
